        ...
        <>
            ...
            <section className={`${Styles.projects_order} ${prevAnimation ? Styles.fade_prev : ""} ${nextAnimation ? Styles.fade_next : ""}`}>
                <div className={Styles.project_sec}>
                    <Link target="_blank" to={filteredProjects[position]?.demo}><img src={filteredProjects[position]?.image} alt={filteredProjects[position]?.title}  className={Styles.imageProject}/></Link>
